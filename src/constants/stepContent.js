export const STEP_CONTENT = {
  1: {
    ...
    helpText:
      "1단계인 웨이퍼 제조 단계에서는 실리콘 잉곳을 원통 모양으로 성장시킨 뒤 얇게 절단하여 웨이퍼를 만들고, 표면을 연마해 매끄럽고 균일한 기판을 확보해요. ",
    modal: {
      title: "웨이퍼 제조 단계 완료!",
  ...
  3: {
    title: "3단계: 포토리소그래피",
    description: (currentSubStep) => {
      if (currentSubStep === 1) return "원하는 마스크를 선택해 주세요.";
      if (currentSubStep === 2)
        return "손전등을 클릭하여 웨이퍼에 \n마스크 모양대로 문양을 남겨봅시다.";
      return "빛을 맞은 부분이 약해졌어요. \n현상액을 부어 그 부분만 씻어내고 \n패턴을 남겨봅시다.";
    },
    subDescription: (currentSubStep) => {
      if (currentSubStep === 2)
        return "* 마스크는 빛을 차단하는 방어막 역할을 합니다. \n마스크 모양대로 원하는 곳에 빛을 노출시킬 수 있어요.";
      return "";
    },
    helpText: (currentSubStep) => {
      if (currentSubStep === 1)
        return "MASK는 석영 판 위에 크롬(Chromium)이라는 금속을 사용해 회로 패턴을 새겨 만들어요.";
      if (currentSubStep === 2)
        return "미세 패턴이 새겨진 마스크를 웨이퍼 위에 맞춰서 정밀하게 위치시켜요. \n10nm 이하 오차로 맞추기 때문에 스테퍼(Stepper)라는 초정밀 장비를 사용해요.";
  ...
  4: {
    title: "4단계: 식각공정",
    description:
      "플라즈마 빔을 이동시켜 Lithography 후 \nPR로 덮여있지 않는 부분을 없애봅시다.",
    subDescription:
      "* 지나간 곳은 다시 지나지 않고 \n모든 길을 한번에 지나가 PR층을 없애보세요.",
    helpText:
      "etching은 건식과 습식 방법이 있습니다. 요즘 공정은 대부분 건식 etching인 플라즈마 etching을 사용해요. \n강한 가스 플라즈마를 이용해, PR로 덮이지 않은 부분만 깎아내여 보호된 부분은 남고, 빈 부분만 파여서 회로 모양이 웨이퍼에 새겨져요.",
    modal: {
      title: "식각공정 단계 완료!",
      description:
        "모든 선분을 한 번씩만 통과했습니다. 다음 단계로 넘어갈까요?",
      confirmText: "다음 단계",
      cancelText: "나가기",
    },
  },
  ...
  6: {
    title: "6단계: 금속 배선",
    description:
      "배선 상자에 있는 배선 조각을 적절한 위치에 \n드래그 하여 배선을 완성해 봅시다.",
    helpText:
      "MOSFET에 배선을 연결 할 때 배선은 Contact이라고 하고, 배선층과 배선층을 잇는 것은 Via(비아)라고 해요.",
    modal: {
      title: "금속 배선 단계 완료!",
  ...
  7: {
    ...
    description: (view) => {
      if (view === "wafer")
        return "빨간색으로 표시된 다이를 눌러 \n불량 여부를 전부 선별해 봅시다.";
      return "예시 범위를 참고하여\n불량 여부를 체크해봅시다.";
    },
    helpText:
      "완성된 웨이퍼의 각 다이에 전기 신호를 인가해 정상 동작 여부를 검사해요. 측정값과 기준을 비교해 불량 칩을 선별하고, 수율을 산출하는 단계에요.",
    modal: {
      title: "EDS 단계 완료!",
